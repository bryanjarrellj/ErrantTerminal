...
public class EnemyWaypointMoveColor : MonoBehaviour, IGameActor, IEnemyActor, IColorActor {

    public EnemyStatus myStatus = EnemyStatus.Idle;
    public EnemyColor myColor = EnemyColor.Blue;
